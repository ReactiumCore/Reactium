// flow-typed signature: dbe0ce65a87ab37502dee047db32a541
// flow-typed version: <<STUB>>/@babel/core_v^7.7.5/flow_v0.116.1
...
declare module '@babel/core/lib/config/config-descriptors.js' {
    declare module.exports: $Exports<
        '@babel/core/lib/config/config-descriptors',
    >;
}
...
declare module '@babel/core/lib/config/helpers/config-api.js' {
    declare module.exports: $Exports<
        '@babel/core/lib/config/helpers/config-api',
    >;
}
...
declare module '@babel/core/lib/config/validation/options.js' {
    declare module.exports: $Exports<
        '@babel/core/lib/config/validation/options',
    >;
}
declare module '@babel/core/lib/config/validation/plugins.js' {
    declare module.exports: $Exports<
        '@babel/core/lib/config/validation/plugins',
    >;
}
declare module '@babel/core/lib/config/validation/removed.js' {
    declare module.exports: $Exports<
        '@babel/core/lib/config/validation/removed',
    >;
}
...
declare module '@babel/core/lib/transformation/file/file.js' {
    declare module.exports: $Exports<
        '@babel/core/lib/transformation/file/file',
    >;
}
