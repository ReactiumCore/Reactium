// flow-typed signature: d8e6c60a2061d5da0cec2ed12a33f711
// flow-typed version: <<STUB>>/redux-devtools-dock-monitor_v^1.1.3/flow_v0.116.1
...
declare module 'redux-devtools-dock-monitor/lib' {
    declare module.exports: any;
}
...
declare module 'redux-devtools-dock-monitor/src' {
    declare module.exports: any;
}
...
declare module 'redux-devtools-dock-monitor/lib/constants.js' {
    declare module.exports: $Exports<
        'redux-devtools-dock-monitor/lib/constants',
    >;
}
declare module 'redux-devtools-dock-monitor/lib/DockMonitor.js' {
    declare module.exports: $Exports<
        'redux-devtools-dock-monitor/lib/DockMonitor',
    >;
}
declare module 'redux-devtools-dock-monitor/lib/index' {
    declare module.exports: $Exports<'redux-devtools-dock-monitor/lib'>;
}
...
declare module 'redux-devtools-dock-monitor/lib/reducers.js' {
    declare module.exports: $Exports<
        'redux-devtools-dock-monitor/lib/reducers',
    >;
}
...
declare module 'redux-devtools-dock-monitor/src/constants.js' {
    declare module.exports: $Exports<
        'redux-devtools-dock-monitor/src/constants',
    >;
}
declare module 'redux-devtools-dock-monitor/src/DockMonitor.js' {
    declare module.exports: $Exports<
        'redux-devtools-dock-monitor/src/DockMonitor',
    >;
}
declare module 'redux-devtools-dock-monitor/src/index' {
    declare module.exports: $Exports<'redux-devtools-dock-monitor/src'>;
}
...
declare module 'redux-devtools-dock-monitor/src/reducers.js' {
    declare module.exports: $Exports<
        'redux-devtools-dock-monitor/src/reducers',
    >;
}
