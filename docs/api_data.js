    ...
    api: [
        {
            ...
            description:
                "<p>Just like React's built-in <code>useEffect</code>, but can use async/await. If the return is a promise for a function, the function will be used as the unmount callback.</p>",
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'cb',
                            description:
                                '<p>Just like callback provided as first argument of <code>useEffect</code>, but takes as its own first argument a method to see if the component is mounted. This is useful for deciding if your async response (i.e. one that would attempt to change state) should happen.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Array',
                            ...
                            field: 'deps',
                            description:
                                '<p>Deps list passed to <code>useEffect</code></p>',
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/async-effect.js',
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'width',
                            description:
                                '<p>the width to check the breakpoint for. Example for the default <code>$breakpoints-max</code> providing a width of 640 or less will return <code>xs</code>, 990 or less will return <code>sm</code> and so on.</p>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'capability',
                            description:
                                '<p>the name/tag of the capability</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>React hook to check a list of capabilities. Uses Reactium.Capability.check().</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'capabilities',
                            description:
                                '<p>array of 1 or more capabilities</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                            ...
                            defaultValue: 'true',
                            description:
                                '<p>when true all capabilities must be allowed for current user</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            field: 'subscriptions',
                            description:
                                '<p>Array of string object-paths in your component props you would like to update your component state for. By default, this is empty, and if left empty you will get only the initial props, and no updates. Each selected property is shallow compared with the previous version of that prop (not the current state). Only a change of prop will trigger a prop-based update and rerender.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                            ...
                            defaultValue: 'false',
                            description:
                                '<p>When true, an update to any subscribed object-path on your props will cause <em>all</em> the props to imprint on your component state.</p>',
                        },
                    ],
                },
            },
            ...
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/derived-state.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'ReactHook',
            ...
            title: 'useDocument()',
            description:
                '<p>Serves same use-case as <code>useWindow()</code>, but provides context aware <code>document</code> object or <code>undefined</code>, that can be used normally as well as in the <code>react-frame-component</code> within the toolkit.</p>',
            name: 'useDocument',
            group: 'ReactHook',
            version: '0.0.0',
            filename: '.core/sdk/named-exports/window.js',
        ...
        },
        {
            ...
            description:
                '<p>React hook to create an imperative handle that is also an implementation of EventTarget. Can be used in conjunction with useImperativeHandle (React built-in) or useRegisterHandle/useHandle (Reactium SDK hooks).</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'handle',
                            description:
                                '<p>Interface for interacting with your component.</p>',
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/event-handle.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'ReactHook',
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'container',
                            description:
                                "<p>The DOM element to search for the 'data-focus' element.</p>",
                        },
                        {
                            group: 'Parameter',
                            type: 'Array',
                            ...
                            field: 'dependencies',
                            description:
                                '<p>Dependencies list passed to <code>useEffect</code>.</p>',
                        },
                    ],
                    Returns: [
                        {
                            ...
                            field: 'focused',
                            description:
                                "<p>If the 'data-focus' element was found.</p>",
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/focus-effect.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'ReactHook',
            ...
            group: 'ReactHook',
            description:
                '<p>Asyncronous React hook that determines if the supplied object has values for the supplied keys. Useful when you have many <code>useEffect</code> calls and need to know if multiple pieces of the state are set and ready for rendering.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'keys',
                            description:
                                '<p>List of object paths to validate.</p>',
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/fulfilled-object.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'ReactHook',
            ...
            title: 'useHandle()',
            description:
                '<p>React hook to subscribe to a specific imperative handle reference. Useful for having one functional component control another.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'id',
                            description:
                                "<p>Array of properties, or <code>.</code> separated object path. e.g. ['path','to','handle'] or 'path.to.handle'. Identifies the full path to an imperative handle.</p>",
                        },
                        {
                            group: 'Parameter',
                            type: 'Mixed',
                            ...
                            field: 'defaultValue',
                            description:
                                '<p>the value to use for the handle if it does not exist.</p>',
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/handle.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'ReactHook',
            ...
            description:
                '<p>A React hook used to define React component(s) that can be overrided by Reactium plugins, using the <code>Reactium.Component.register()</code> function.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'hookName',
                            description:
                                '<p>the unique string used to register component(s).</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Component',
                            ...
                            description:
                                '<p>the default React component(s) to be returned by the hook.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Mixed',
                            ...
                            field: 'params',
                            description:
                                '<p>variadic list of parameters to be passed to the Reactium hook specified by hookName.</p>',
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/component.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'ReactHook',
            ...
            group: 'ReactHook',
            description:
                '<p>React hook that determines if the element is a child of the container. Useful for traversing the DOM to find out if an event or action happened within the specified container.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'element',
                            description:
                                '<p>The inner most element. Consider this the starting point.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Node',
                            ...
                            field: 'container',
                            description:
                                '<p>The outer most element. Consider this the destination.</p>',
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/is-container.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'ReactHook',
            ...
            title: 'useReduxState()',
            description:
                "<p>Similar to React useState(), returns selected redux state, and action dispatching function, as the first and second elements of an array.</p> <p>Takes an optional shouldUpdate callback (see useSelect), which does a shallow comparison of previous and current selected state by default. The update callback returned expects to be called with an object, and will cause a dispatch: { type: 'DOMAIN_UPDATE', domain, // the passed domain update, // object passed to update }</p> <p>Note: the boilerplate redux reducer created with <code>arcli component</code> will target action dispatched from this hoook.</p>",
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'select',
                            description:
                                '<p>Optional select callback (see useSelect), which selects for the domain by default.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Function',
                            ...
                            field: 'shouldUpdate',
                            description:
                                '<p>Optional shouldUpdate callback (see useSelect), which does a shallow comparison of previous and current selected state by default.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/redux.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'ReactHook',
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            field: 'cb',
                            description:
                                '<p>Function that returns value to be assigned to the imperative handle reference.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Array',
                            ...
                            field: 'deps',
                            description:
                                '<p>Array of values to watch for changes. When changed, your reference will be updated by calling <code>cb</code> again. All <code>Reactium.Handle.subscribe()</code> subscribers will be called on updates, and relevant <code>useHandle()</code> hooks will trigger rerenders.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            title: 'useRoles()',
            description:
                '<p>React hook to get roles object. If search is provided, will retrieve a specific role.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'search',
                            description:
                                '<p>Name, level or object id of the roles to retrieve. If not provide, an object will all roles will be returned.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            title: 'useSelect()',
            description:
                '<p>React hook for subscribing to only the updates from Redux store that you care about, and no more. This is superior to <code>react-redux</code> connect, in that your component will not update on every dispatch, only those state changes you have specifically targeted.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'params',
                            description:
                                '<ol> <li>Callback function taking current state object from Redux store, and returning what you care about, or</li> <li>an Object with <code>select</code> and <code>shouldUpdate</code> props.</li> </ol>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Function',
                            ...
                            field: 'params.select',
                            description:
                                '<p>Callback function taking current state object from Redux store, and returning what you care about.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Function',
        ...
        },
        {
            ...
            title: 'useStore()',
            description:
                '<p>Just gimme the store damnit! This React hook provides the Redux store when used on a component declared within the Store Provider.</p>',
            name: 'useStore',
            group: 'ReactHook',
            examples: [
                {
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'params',
                            description:
                                '<p><code>defaultWidth</code>, <code>defaultHeight</code>, and debounce <code>delay</code> properties.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Number',
                            ...
                            defaultValue: '1',
                            description:
                                '<p>Default width returned by the hook when window object is <code>undefined</code>.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Number',
                            ...
                            defaultValue: '1',
                            description:
                                '<p>Default height returned by the hook when window object is <code>undefined</code>.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Number',
                            ...
                            defaultValue: '0',
                            description:
                                '<p>Debounce delay to throttle many window resize events, to prevent unnecessary rerenders of your component using this hook.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/zone/Zone.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'Object',
            ...
            description:
                '<p>Cache allows you to easily store application data in memory.</p>',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/cache/index.js',
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'key',
                            description:
                                '<p>The key to delete. If the value is an <code>{Object}</code> you can use an object path to delete a specific part of the value. The updated value is then returned.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Cache.del',
            description:
                '<p>Delete the value for a given key. Returns <code>{Boolean}</code>.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            name: 'Cache.get',
            description:
                '<p>Retrieves the value for a given key. If the value is not cached <code>null</code> is returned.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'key',
                            description:
                                '<p>The key to retrieve. If the value is an <code>{Object}</code> you can use an object path for the key. If no key is specified the entire cache is returned.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Mixed',
                            ...
                            field: 'default',
                            description:
                                '<p>The default value to return if key is not found.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Cache.memsize',
            description:
                '<p>Returns the number of entries taking up space in the cache.</p>',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/cache/index.js',
            groupTitle: 'Reactium.Cache',
        },
        {
            ...
            name: 'Cache.merge',
            description:
                '<p>Merges the supplied values object with the current cache. Any existing entries will remain in cache. Duplicates will be overwritten unless <code>option.skipDuplicates</code> is <code>true</code>. Entries that would have exipired since being merged will expire upon merge but their timeoutCallback will not be invoked. Returns the new size of the cache.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'values',
                            description:
                                '<p>Key value pairs to merge into the cache.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Cache.set',
            description:
                '<p>Sets the value for a given key. If the value is an <code>{Object}</code> and is already cached, you can use an object path to update a specific part of the value. Returns the cached value.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'key',
                            description:
                                '<p>The key to set. If the key is an object path and the key does not exist, it will be created.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Mixed',
                        ...
                        },
                        {
                            ...
                            field: 'timeout',
                            description:
                                '<p>Remove the value in the specified time in milliseconds. If no timeout value specified, the value will remain indefinitely.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Function',
                            ...
                            description:
                                '<p>Function called when the timeout has expired. The timeoutCallback will be passed the key and value as arguments.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Cache.size',
            description:
                '<p>Returns the current number of entries in the cache.</p>',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/cache/index.js',
            groupTitle: 'Reactium.Cache',
        },
        {
            ...
            description:
                '<p>Subscribe to cache changes that impact a particular key. Returns an unsubscribe function.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'key',
                            description:
                                '<p>object path of the cache value (array or string)</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Function',
                            ...
                            field: 'cb',
                            description:
                                '<p>The callback function to call when impacting changes have been made to the subscribed cache. Changes include any set/put, delete, clear, merge, or expiration that <em>may</em> impact the value you care about.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            version: '3.2.1',
            description:
                '<p>Check a list of capabilities on the current user.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'capabilities',
                            description:
                                '<p>list of string capabilities to check, returns true if current user is allowed, false if not allowed</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                            ...
                            defaultValue: 'true',
                            description:
                                '<p>When true all capabilities must be allowed for user for check to return true, otherwise only one capability is required to get a true value.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            version: '3.2.1',
            description:
                '<p>Get allowed and excluded roles for a capability.</p>',
            name: 'Capability.get',
            group: 'Reactium.Capability',
            examples: [
                {
        ...
        },
        {
            ...
            version: '3.2.1',
            description:
                '<p>Set permissions on a capability for allowed and excluded roles.</p>',
            name: 'Capability.set',
            group: 'Reactium.Capability',
            examples: [
                {
        ...
        },
        {
            ...
            description:
                '<p>Register a React component to be used with a specific useHookComponent hook. This must be called before the useHookComponent that defines the hook.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'component',
                            description:
                                '<p>component(s) to be output by useHookComponent</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Number',
                            ...
                            field: 'order',
                            description:
                                '<p>precedent of this if Component.register is called multiple times (e.g. if you are trying to override core or another plugin)</p>',
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/component/index.js',
        ...
        },
        {
            ...
            description:
                '<p>Unregister a component used in useHookComponent. This must be performed before useHookComponent is called. Alias for Reactium.Hook.unregister. See Hook.unregister()</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'uuid',
                            description:
                                '<p>the registered component hook id provided to <code>Component.register()</code></p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            title: 'Handle.get()',
            description:
                "<p>Get a specific imperative handle reference, by object path (id). If id is full object path to the handle, returns a React reference if it exists, otherwise <code>undefined</code>. If id is partial object path, returns object containing one or more references if the path exists, otherwise 'undefined'.</p>",
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'id',
                            description:
                                "<p>Array of properties, or <code>.</code> separated object path. e.g. ['path','to','handle'] or 'path.to.handle'</p>",
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/handle/index.js',
        ...
        },
        {
            ...
            title: 'Handle.list()',
            description:
                '<p>Get full object containing all current reference handles.</p>',
            name: 'Handle.list',
            group: 'Reactium.Handle',
            version: '0.0.0',
            filename:
        ...
        },
        {
            ...
            description:
                '<p>Register an imperative handle reference. See <code>useRegisterHandle()</code> React hook for easier pattern for functional components.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'ref',
                            description:
                                '<p>React reference created with <code>React.createRef()`` or </code>React.useRef()`.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                            ...
                            defaultValue: 'true',
                            description:
                                '<p>Update <code>useHandle</code> subscribers of this handle id.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Subscribe to changes in imperative handle references (registrations and unregistrations). Returns unsubscribe function.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'cb',
                            description:
                                '<p>callback to be called when a handle is registered or unregistered</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Unregister an imperative handle reference. See <code>Handle.register()</code> for example usage.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/hook/index.js',
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            field: 'callback',
                            description:
                                '<p>function returning promise that will be called when the hook is run. The hook callback will receive any parameters provided to Hook.run, followed by a context object.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Integer',
                            ...
                            description:
                                '<p>order of which the callback will be called when this hook is run.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
                            ...
                            field: 'id',
                            description:
                                '<p>the unique id. If not provided, a uuid will be generated</p>',
                        },
                    ],
                },
            },
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            field: '...params',
                            description:
                                '<p>any number of arbitrary parameters (variadic)</p>',
                        },
                    ],
                },
            },
                    ...
                    'Success 200': [
                        {
                            ...
                            field: 'context',
                            description:
                                '<p>context object passed to each callback (after other variadic parameters)</p>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'id',
                            description:
                                '<p>the unique id provided by Hook.register() or Hook.list()</p>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'ssr',
                            description:
                                '<p>If the app is in server-side rendering mode <code>true</code> is passed to the hook.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Register a new Redux middleware. This should be called only:</p> <ol> <li>within <code>Reactium.Plugin.register()</code> promise callback,</li> <li>or after the <code>plugin-dependencies</code> hook, (e.g. <code>plugin-init</code>)</li> <li>or after <code>Reactium.Plugin.ready === true</code>.</li> </ol>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'mw',
                            description:
                                '<p>Redux middleware high-order function (store =&gt; action =&gt; next =&gt; {})</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Integer',
                            ...
                            defaultValue: 'Enums.priority.neutral',
                            description:
                                '<p>Priority of the middleware respective to other existing Redux middleware.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            defaultValue: 'Enums.priority.neutral',
                            description:
                                '<p>Priority of the plugin initialization respective to other existing plugins.</p>',
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/plugin/index.js',
        ...
        },
        {
            ...
            description:
                '<p>Unregister a Reactium plugin by unique id. This can only be called prior to the <code>plugin-dependencies</code> hook, or <code>Reactium.Plugin.ready === true</code>.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'key',
                            description:
                                '<p>If specified as an object-path, will unset a specific preference path. Otherwise, all preferences will be cleared.</p>',
                        },
                    ],
                },
            },
            ...
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/prefs/index.js',
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'key',
                            description:
                                '<p>If specified as an object-path, will get a specific preference by this path. Otherwise, all preferences will be returned.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
                            ...
                            field: 'defaultValue',
                            description:
                                '<p>The value to return if the preference has not been set.</p>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'key',
                            description:
                                '<p>The object-path to use to set the value.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
        ...
        },
        {
            ...
            description:
                '<p>Pulse Task object that performs the heavy lifting for the Pulse API.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
        ...
        },
        {
            ...
            description:
                '<p>[read-only] The unique ID of the task. Returns: <code>String</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>[read-only] The current attempt for the active task. Returns: <code>Number</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            name: 'Reactium.Pulse.Task.attempt',
            description:
                '<p>The current attempt for the active task. Returns: <code>Number</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>The number of times a task will retry before it fails. Default: <code>-1</code>. You can set this value after the task has started.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>[read-only] If the task autastarted upon creation. Default: <code>true</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>[read-only] Relevant only when the <code>repeat</code> property is higher than 1. Returns: <code>Boolean</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>[read-only] The current number of times the task has succeeded. Returns: <code>Number</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>[read-only] The current error message if applicable. Returns: <code>string</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>[read-only] Expresses if the current task has reached the maximum attempts. Returns: <code>Boolean</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                "<p>Force run the task without waiting for it's delay. If the task is running this is a <code>noop</code>.</p>",
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>[read-only] The current amount of the repeat that has been completed. Relevant only when <code>repeat</code> is higher than 1. Returns: <code>0-1</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>The current number of times to run the task. Returns: <code>Number</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>Force a retry of the task. Useful for when you want to manually handle retries within your callback function.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>Start the task. Useful for when you want manually start a task in your callback function.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            description:
                '<p>[read-only] The current status of the task. For comparing the status use the Pulse.ENUMS.STATUS values</p>',
            examples: [
                {
                    title: 'Example usage:',
                    content:
        ...
        },
        {
            ...
            description:
                '<p>[read-only] The reference to the current setTimeout. This value will change for each task run. Returns: <code>Number</code>.</p>',
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse.Task',
        },
        {
            ...
            name: 'Pulse.get',
            description:
                '<p>Retrieve a registered task. Returns a <code>Pulse.Task</code> object.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            field: 'callback',
                            description:
                                '<p>The function to execute when the task is run. The first parameter passed to the callback function will be a reference to the current task object.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Object',
                            ...
                            field: 'options',
                            description:
                                '<p>The <code>Pulse.Task</code> configuration object.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Number',
                            ...
                            defaultValue: '-1',
                            description:
                                '<p>Number of times to retry a task. By default the task will retry indefinitely.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                            ...
                            defaultValue: 'true',
                            description:
                                '<p>Start the task when it is registered.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Number',
                            ...
                            defaultValue: '1000',
                            description:
                                "<p>Time in milliseconds before the task is run again. The task will not run again until after it's callback has been executed.</p>",
                        },
                        {
                            group: 'Parameter',
                            type: 'Number',
                            ...
                            defaultValue: '-1',
                            description:
                                '<p>Number of times to repeat the task. Used in determining if the task is complete. A task with -1 as the value will never complete.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Arguments',
                            ...
                            field: 'params',
                            description:
                                '<p>Additional parameters to pass to the callback function.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                "<p>Stop and unregister a task. If the task is running, it's current attempt will resolve before the task is removed.</p>",
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            description:
                "<p>Resets the task's attempt count and run count. Useful for catastrophic failures in your callback function.</p>",
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/pulse/index.js',
            groupTitle: 'Reactium.Pulse',
        },
        {
            ...
            description:
                '<p>Register a Redux reducer. This should be called only:</p> <ol> <li>within <code>Reactium.Plugin.register()</code> promise callback,</li> <li>or after the <code>plugin-dependencies</code> hook, (e.g. <code>plugin-init</code>)</li> <li>or after <code>Reactium.Plugin.ready === true</code>.</li> </ol>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'pluginName',
                            description:
                                '<p>the unique name of your plugin</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'pluginName',
                            description:
                                '<p>the unique name of your plugin. This should be called only:</p> <ol> <li>within <code>Reactium.Plugin.register()</code> promise callback,</li> <li>or after the <code>plugin-dependencies</code> hook, (e.g. <code>plugin-init</code>)</li> <li>or after <code>Reactium.Plugin.ready === true</code>.</li> </ol>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Routing.get',
            description:
                '<p>Get sorted array of all route objects. This includes the NotFound component. If called prior to the <code>routes-init</code> hook completion, will contain only the NotFound component.</p>',
        ...
        },
        {
            ...
            description:
                '<p>Dynamically register a new React router route.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            description:
                "<p>Unregister an existing route, by id. Note: You can not unregister the 'NotFound' component. You can only replace it using the <code>404-component</code> hook.</p>",
            group: 'Reactium.Routing',
            version: '0.0.0',
            filename: '.core/sdk/routing/index.js',
            groupTitle: 'Reactium.Routing',
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            field: 'defaultValue',
                            description:
                                "<p>The default value if the setting doesn't exist.</p>",
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                            ...
                            field: 'refresh',
                            description:
                                '<p>if true, get a fresh value, even if already cached.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            group: 'Reactium.Setting',
            description:
                '<p>Load all settings, with cache. When called multiple times in the cache period, the result will come from memory cache.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            defaultValue: 'true',
                            description:
                                '<p>when true, settings will be automatically loaded again every <code>Enums.cache.settings</code> milliseconds. When false, auto reload of settings will not happen.</p>',
                        },
                    ],
                },
            },
                    ...
                    'Success 200': [
                        {
                            ...
                            field: 'settings',
                            description:
                                '<p>an object with setting the current user has access to.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Setting.set',
            description:
                '<p>Create or update a setting value. Returns a <code>{Promise}</code>.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            defaultValue: 'false',
                            description:
                                '<p>When true, this settings will be readable by anonymous. Useful for global insensitive application settings, such as &quot;site name&quot;.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Setting.unset',
            description:
                '<p>Unset a setting value. Returns a <code>{Promise}</code>.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            description:
                '<p>Mutate the <code>Actinium.User.meta</code> object by deleting a key value pair. Calls the <code>user-meta-delete</code> cloud function.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'params',
                            description:
                                '<p>Object containing parameters for retrieving a user and the key value pair to apply to the user meta object.</p>',
                        },
                    ],
                    params: [
                        {
                            ...
                            field: 'objectId',
                            description:
                                '<p>Look up the user object by the objectId field. See <a href="#api-Reactium.User-User.retrieve">User.retrieve()</a>.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'username',
                            description:
                                '<p>Look up the user object by the username field. See <a href="#api-Reactium.User-User.retrieve">User.retrieve()</a>.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'email',
                            description:
                                '<p>Look up the user object by the email field. See <a href="#api-Reactium.User-User.retrieve">User.retrieve()</a>.</p>',
                        },
                    ],
                    hooks: [
                        {
                            ...
                            description:
                                '<p>Triggered before the <code>user-meta-delete</code> cloud function is called.</p> <pre class="prettyprint">Arguments: params:Object </code></pre>',
                        },
                        {
                            group: 'hooks',
                            type: 'Hook',
                            ...
                            description:
                                '<p>Triggered after the <code>user-meta-delete</code> cloud function is called.</p> <pre class="prettyprint">Arguments: user:Actinium.user, params:Object </code></pre>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Mutate the <code>Actinium.User.meta</code> object. Calls the <code>user-meta-update</code> cloud function.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                    ...
                    hooks: [
                        {
                            ...
                            description:
                                '<p>Triggered before the <code>user-meta-update</code> cloud function is called.</p> <pre class="prettyprint">Arguments: params:Object </code></pre>',
                        },
                        {
                            group: 'hooks',
                            type: 'Hook',
                            ...
                            description:
                                '<p>Triggered after the <code>user-meta-update</code> cloud function is called.</p> <pre class="prettyprint">Arguments: user:Actinium.user, params:Object </code></pre>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Mutate the <code>Actinium.User.pref</code> object by deleting a key value pair. Calls the <code>user-pref-delete</code> cloud function.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'params',
                            description:
                                '<p>Object containing parameters for retrieving a user and the key value pair to apply to the user pref object.</p>',
                        },
                    ],
                    params: [
                        {
                    ...
                    hooks: [
                        {
                            ...
                            description:
                                '<p>Triggered before the <code>user-pref-delete</code> cloud function is called.</p> <pre class="prettyprint">Arguments: params:Object </code></pre>',
                        },
                        {
                            group: 'hooks',
                            type: 'Hook',
                            ...
                            description:
                                '<p>Triggered after the <code>user-pref-delete</code> cloud function is called.</p> <pre class="prettyprint">Arguments: user:Actinium.user, params:Object </code></pre>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Mutate the <code>Actinium.User.pref</code> object. Calls the <code>user-pref-update</code> cloud function.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                    ...
                    hooks: [
                        {
                            ...
                            description:
                                '<p>Triggered before the <code>user-pref-update</code> cloud function is called.</p> <pre class="prettyprint">Arguments: params:Object </code></pre>',
                        },
                        {
                            group: 'hooks',
                            type: 'Hook',
                            ...
                            description:
                                '<p>Triggered after the <code>user-pref-update</code> cloud function is called.</p> <pre class="prettyprint">Arguments: user:Actinium.user, params:Object </code></pre>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'role',
                            description:
                                "<p>The role name. Example: 'super-admin'.</p>",
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
                            ...
                            field: 'objectId',
                            description:
                                '<p>The objectId of the user. If empty the current user is used.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            title: 'User.can()',
            description:
                '<p>Asyncronously find out if a user has a set of capabilities.</p>',
            name: 'User.can',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'capabilities',
                            description:
                                '<p>The capability(s) to check for (string or array)</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                            ...
                            defaultValue: 'true',
                            description:
                                '<p>Compare capabilities where the user must have all capabilities <code>[true]</code>, or at least 1 <code>[false]</code>.</p>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            defaultValue: 'false',
                            description:
                                '<p>By default the return value is an object. If you need the Actinium.User object instead pass <code>true</code>.</p>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'email',
                            description:
                                '<p>The email address associated with a user object.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>If the user is logged in, get the current session token.</p>',
        ...
        },
        {
            ...
            description:
                '<p>Check to make sure the current user and associated session are valid.</p>',
        ...
        },
        {
            ...
            title: 'User.isRole()',
            description:
                '<p>Asyncronously find out if a user is a member of a specific role.</p>',
            name: 'User.isRole',
            parameter: {
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            field: 'objectId',
                            description:
                                '<p>The objectId of the user. If empty, the User.current() object is used.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'User.list',
            description:
                '<p>Retrieve a list of <code>Actinium.User</code> objects. Calls the <code>user-list</code> cloud function.</p>',
            parameter: {
                fields: {
                    params: [
                        {
                            ...
                            field: 'role',
                            description:
                                '<p>Filter the results to the specified <code>Actinium.Role</code> name.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'search',
                            description:
                                '<p>Search using logical <code>or</code>. The query will RegExp compare to the default fields: <code>username</code>, <code>email</code>, <code>fname</code>, <code>lname</code>.</p> <p><em>Note:</em> You can add or remove fields via the <code>user-search-fields</code> hook.</p>',
                        },
                        {
                            group: 'params',
                            type: 'Mixed',
                            ...
                            field: 'objectId',
                            description:
                                '<p><code>{String|Array}</code> Search for a specific objectId or array of objectIds.</p> <p><em>Note:</em> If <code>search</code> is specified, this value is ignored.</p>',
                        },
                        {
                            group: 'params',
                            type: 'Mixed',
                            ...
                            field: 'email',
                            description:
                                '<p><code>{String|Array}</code> Search for a specific email address or array of email addresses.</p> <p><em>Note:</em> If <code>search</code> is specified, this value is ignored.</p>',
                        },
                        {
                            group: 'params',
                            type: 'Mixed',
                            ...
                            field: 'username',
                            description:
                                '<p><code>{String|Array}</code> Search for a specific username or array of usernames.</p> <p><em>Note:</em> If <code>search</code> is specified, this value is ignored.</p>',
                        },
                        {
                            group: 'params',
                            type: 'Boolean',
                            ...
                            defaultValue: 'false',
                            description:
                                '<p>If the count of the results is less than or equal to 1000, all objects will be returned. The page number will be set to 1 and the number of pages will also be 1.</p>',
                        },
                        {
                            group: 'params',
                            type: 'Boolean',
                            ...
                            defaultValue: 'false',
                            description:
                                '<p>By default the results are cached for 90 seconds. You can flush the cache with this parameter.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'indexBy',
                            description:
                                '<p>Index the results by the specified field and return them as an Object.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'order',
                            description:
                                '<p>Order the results <code>ascending</code> or <code>descending</code>.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            description:
                                '<p>Order the results by the specified field.</p>',
                        },
                        {
                            group: 'params',
                            type: 'Number',
                            ...
                            defaultValue: '1',
                            description:
                                '<p>The page number of results to return.</p>',
                        },
                        {
                            group: 'params',
                            type: 'Number',
                    ...
                    hooks: [
                        {
                            ...
                            description:
                                '<p>Triggered before the user-list Cloud function is called.</p> <pre class="prettyprint">Arguments: params:Object </code></pre>',
                        },
                        {
                            group: 'hooks',
                            type: 'Hook',
                            ...
                            description:
                                '<p>Triggered after the user-list Cloud function is called.</p> <pre class="prettyprint">Arguments: response:Object, params:Object </code></pre>',
                        },
                    ],
                },
            },
                    ...
                    params: [
                        {
                            ...
                            field: 'username',
                            description:
                                '<p>Unique username used when authenticating.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'password',
                            description:
                                '<p>Password used when authenticating.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                        ...
                        },
                        {
                            ...
                            field: 'email',
                            description:
                                '<p>Email address used when resetting password and for system messaging.</p>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'token',
                            description:
                                '<p>The token received from the <code>User.forgot()</code> email message.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
        ...
        },
        {
            ...
            name: 'User.retrieve',
            description:
                '<p>Retrieve a single <code>Actinium.User</code> object. Calls the <code>user-retrieve</code> cloud function.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'params',
                            description:
                                '<p>Query parameters. See <a href="#api-Reactium.User-User.list">User.list()</a> for more details.</p>',
                        },
                    ],
                    params: [
                        {
                            ...
                            field: 'objectId',
                            description:
                                '<p>Retrieve by the objectId field.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'username',
                            description:
                                '<p>Retrieve by the username field.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'email',
                            description:
                                '<p>Retrieve by the email address field.</p>',
                        },
                    ],
                    hooks: [
                        {
                            ...
                            description:
                                '<p>Triggered before the <code>user-retrieve</code> cloud function is called.</p> <pre class="prettyprint">Arguments: params:Object </code></pre>',
                        },
                        {
                            group: 'hooks',
                            type: 'Hook',
                            ...
                            field: 'user-retrieve',
                            description:
                                '<p>Triggered after the <code>user-retrieve</code> cloud function is called.</p> <pre class="prettyprint">Arguments: user:Object, params:Object </code></pre>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'params',
                            description:
                                '<p>Key value pairs to apply to the <code>Actinium.User</code> object. Calls the <code>user-save</code> cloud function.</p> <p><em>Note:</em> Any additional key value pairs will be added to the user object as a new column.</p>',
                        },
                    ],
                    params: [
                        {
                            ...
                            field: 'username',
                            description:
                                '<p>The unique username used when signing in.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'email',
                            description:
                                '<p>The email address to associate with the user account.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'password',
                            description:
                                '<p>The password used when signing in.</p>',
                        },
                        {
                            group: 'params',
                            type: 'String',
                            ...
                            field: 'role',
                            description:
                                '<p>The <code>Actinium.Role</code> name to add the user to.</p>',
                        },
                    ],
                    hooks: [
                        {
                            ...
                            description:
                                '<p>Mutate the <code>Actinium.User</code> object before save is complete.</p> <pre class="prettyprint">Arguments:  req:Object:Actinium.User </code></pre>',
                        },
                        {
                            group: 'hooks',
                            type: 'Hook',
                            ...
                            description:
                                '<p>Take action after the <code>Actinium.User</code> object has been saved.</p> <pre class="prettyprint">Arguments: req:Object:Actinium.User </code></pre>',
                        },
                        {
                            group: 'hooks',
                            type: 'Hook',
                            ...
                            description:
                                '<p>Take action after the <code>Actinium.User</code> returns an error.</p> <pre class="prettyprint">Arguments: error:Object, params:Object </code></pre>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'Convert',
                            description:
                                '<p>a <code>Actinium.User</code> object into a JSON object. If the object is already serialized it is returned.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'User.trash',
            description:
                '<p>Send a single <code>Actinium.User</code> object to the recycle bin. Calls <code>user-trash</code> cloud function.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'params',
                            description:
                                '<p>Object containing parameters for deleting a user.</p>',
                        },
                    ],
                    params: [
                        {
                    ...
                    hooks: [
                        {
                            ...
                            description:
                                '<p>Triggered before the <code>user-trash</code> cloud function is run.</p> <pre class="prettyprint">Arguments: user:Actinium.User </code></pre>',
                        },
                        {
                            group: 'hooks',
                            type: 'Hook',
                            ...
                            field: 'user-trash',
                            description:
                                '<p>Triggered after the <code>user-trash</code> cloud function is run.</p> <pre class="prettyprint">Arguments: user:Actinium.User </code></pre>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Fullscreen',
            description:
                '<p>Cross browser utility for toggling fullscreen mode.</p>',
            parameter: {
                fields: {
                    Event: [
                        {
                            ...
                            description:
                                "<p>Triggered when the browser's fullscreen state changes.</p>",
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/fullscreen.js',
        ...
        },
        {
            ...
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/utils/index.js',
            groupTitle: 'Reactium.Utilities',
        },
        {
            type: 'Function',
                    ...
                    Parameter: [
                        {
                            ...
                            description:
                                '<p>Custom width to check. Useful if you have a resize event and want to skip the function from looking up the value again. Reactium.Utils.breakpoint(); // Returns: the current window.innerWidth breakpoint.</p> <p>Reactium.Utils.breakpoint(1024); // Returns: sm</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Determine if window is an electron window. Useful for detecting electron usage.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            name: 'Utils.isWindow',
            description:
                '<p>Determine if the window object has been set. Useful when developing for server side rendering.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            title: 'ec()',
            description:
                '<p>ec, short for &quot;easy connect&quot; is a stripped down version of the redux <code>connect</code> function, which will provide your component with any Redux state properties under the name matching your component class (if applicable), as well as a <code>getState</code> function property.</p>',
            name: 'ec',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'Component',
                            description:
                                '<p>the React component to be decorated with Redux state.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'domain',
                            ...
                            field: 'domain',
                            description:
                                '<p>domain or object path to get from state. if not provided, will used Component.name property.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Create a CSS classname namespace (prefix) to use on one or more sub-class. Uses the same syntax as the <code>classnames</code> library.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            description:
                '<p>Breaks formatted string (or array of strings), into flat array of parts/nodes, inserting an object in array in the place of <code>%key%</code>. Useful for tokenizing a translation string, and getting an array that can easily be mapped into React components. Returns an object with <code>replace</code> and <code>value</code> methods. Call <code>replace(key,value)</code> method (chaining) as many times as necessary to replace all tokens. Call <code>value()</code> method to get the final array of Part objects. Call <code>reset()</code> to reset the SlipParts object to the original string without replacements for reuse.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'parts',
                            description:
                                '<p>String containing tokens like <code>%key%</code> to be replaced.</p>',
                        },
                    ],
                    replace: [
                        {
                            ...
                            field: 'key',
                            description:
                                '<p>when calling <code>replace(key,value)</code>, the token <code>%${key}%</code> will be replaced with an Part object key-&gt;value pair.</p>',
                        },
                        {
                            group: 'replace',
                            type: 'Mixed',
                            ...
                            field: 'value',
                            description:
                                '<p>the value to use in the key-&gt;pair replacement</p>',
                        },
                    ],
                    Part: [
                        {
        ...
        },
        {
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'zone',
                            description:
                                '<p>component object, determines what component renders in a zone, what order and additional properties to pass to the component.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Array',
                            ...
                            field: 'capabilities',
                            description:
                                '<p>list of capabilities to check before adding component to zone. Can also be added as property of zone component object.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                            ...
                            defaultValue: 'true',
                            description:
                                '<p>true to only add component if all capabilities are allowed, otherwise only one capability is necessary</p>',
                        },
                    ],
                },
            },
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/zone/index.js',
        ...
        },
        {
            ...
            name: 'Zone.addFilter',
            description:
                '<p>Add a component zone filter function, used to filter which components will appear in <code>&lt;Zone /&gt;</code> Returns unique id.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'zone',
                            description:
                                '<p>the zone this filter will apply to</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
                            ...
                            field: 'filter',
                            description:
                                '<p>the filter function that will be passed each zone component object</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
                            ...
                            defaultValue: 'Enums.priority.neutral',
                            description:
                                '<p>the priority your filter will take in list of filters in this zone</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Zone.addMapper',
            description:
                '<p>Add a component zone mapping function, used to augment the zone component object before passed to <code>&lt;Zone /&gt;</code>. Returns unique id.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'zone',
                            description:
                                '<p>the zone this mapper will apply to</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
                            ...
                            field: 'mapper',
                            description:
                                '<p>the mapper function that will be passed each component object</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
                            ...
                            defaultValue: 'Enums.priority.neutral',
                            description:
                                '<p>the priority your mapper will take in list of mappers in this zone</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            name: 'Zone.addSort',
            description:
                '<p>Add a component zone sort critera, used to augment the zone component object before passed to <code>&lt;Zone /&gt;</code></p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'zone',
                            description:
                                '<p>the zone this sort will apply to</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'String',
                            ...
                            defaultValue: 'order',
                            description:
                                '<p>zone component object property to sort the list of components by</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                        ...
                        },
                        {
                            ...
                            defaultValue: 'Enums.priority.neutral',
                            description:
                                '<p>the priority your sort will take in list of sorts in this zone</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Removes a component added by <code>Zone.addComponent()</code> from a component zone by id.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'ID',
                            description:
                                '<p>the unique component object id.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Remove filter functions for a component zone for this component.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'id',
                            description:
                                '<p>the id of the mapper to remove from the zone</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Remove sort critera for a component zone for this component. This should be called only: //   * @apiParam {String} zone the zone to remove this sort from</p>',
            group: 'Reactium.Zone',
            examples: [
                {
                    title: 'Example Usage',
        ...
        },
        {
            ...
            name: 'Zone.subscribe',
            description:
                '<p>Subscribe to components added, removed, or updated in a particular rendering zone. Returns an unsubscribe function. Call this function to unsubscribe from changes.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'callback',
                            description:
                                '<p>a function that will be called when a change occurs to zone.</p>',
                        },
                    ],
                },
            },
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            description:
                                '<p>updated zone component object, will be merged with existing.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Unregister a Redux middleware. This should be called only:</p> <ol> <li>within <code>Reactium.Plugin.register()</code> promise callback,</li> <li>or after the <code>plugin-dependencies</code> hook, (e.g. <code>plugin-init</code>)</li> <li>or after <code>Reactium.Plugin.ready === true</code>.</li> </ol>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'zone',
                            description:
                                '<p>Identifier of the zone where plugin components will be rendered.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Boolean',
                        ...
                        },
                        {
                            ...
                            field: '...params',
                            description:
                                '<p>any number of arbitrary parameters (variadic) can be provided to the Zone, and will be passed automatically as props on your plugin components when they are rendered.</p>',
                        },
                    ],
                },
            },
            ...
            examples: [
                ...
                {
                    title:
                        'src/app/components/plugin-src/MyHeaderPlugin/index.js',
                    content:
                ...
                {
                    title:
                        'src/app/components/plugin-src/MyHeaderPlugin/MyHeaderWidget.js',
                    content:
        ...
        },
        {
            ...
            title: '__()',
            description:
                '<p>Wrap this around string literals to make them translateable with gettext Poedit utility. Run <code>arcli i18n</code> to extract strings to <code>src/reactium-translations/template.pot</code> by default.</p>',
            name: '__',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'text',
                            description:
                                '<p>the text to be translated. Important: this should not be a variable. It must be a string literal, or <code>arcli i18n</code> command will not be able to locate the string. This string may not be an ES6 template literal.</p>',
                        },
                    ],
                },
            },
                    ...
                    Parameter: [
                        {
                            ...
                            field: 'singular',
                            description:
                                '<p>the singular form text to be translated. Important: this should not be a variable. It must be a string literal, or <code>arcli i18n</code> command will not be able to locate the string. This string may not be an ES6 template literal.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'StringLiteral',
                            ...
                            field: 'plural',
                            description:
                                '<p>the plural form text to be translated. Important: this should not be a variable. It must be a string literal, or <code>arcli i18n</code> command will not be able to locate the string. This string may not be an ES6 template literal.</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Number',
                            ...
                            field: 'count',
                            description:
                                '<p>the number related to singular or plural string</p>',
                        },
                    ],
                },
            },
