    ...
    function ma(b) {
        ...
        function e(a) {
            var n,
                b = a ? a.indexOf('!') : -1;
            -1 < b &&
                ((n = a.substring(0, b)), (a = a.substring(b + 1, a.length)));
            return [n, a];
        }
        function q(a, n, b, f) {
            var l,
        ...
        function I() {
            var a,
                ...
                c =
                    (a = 1e3 * m.waitSeconds) &&
                    h.startTime + a < new Date().getTime(),
                f = [],
                l = [],
                k = !1,
                g = !0;
                ...
                a.packages &&
                    x(a.packages, function(a) {
                        ...
                        m.pkgs[b] =
                            a.name +
                            '/' +
                            (a.main || 'main').replace(na, '').replace(V, '');
                    });
                E(t, function(a, b) {
            ...
            makeRequire: function(a, n) {
                function e(c, d, g) {
                    ...
                    if ('string' === typeof c) {
                        if (L(d))
                            return B(
                                G('requireargs', 'Invalid require call'),
                                g,
                            );
