    ...
    (function() {
        function T(a) {
            ...
            function b(e) {
                ...
                for (a = 0; a < e.length; ++a)
                    (h = e[a]),
                        h[0] <= g[1] + 1
                            ? (g[1] = Math.max(g[1], h[1]))
                            : b.push((g = h));
                for (a = 0; a < b.length; ++a)
                    (h = b[a]),
                        c.push(f(h[0])),
                        h[1] > h[0] &&
                            (h[1] + 1 > h[0] && c.push('-'), c.push(f(h[1])));
                c.push(']');
                return c.join('');
            }
            function v(e) {
                ...
                for (
                    ...
                    if (h) {
                        ...
                        var B = z.indexOf(h),
                            D = B + h.length;
                        g[2] &&
                            ((D = z.length - g[2].length), (B = D - h.length));
                        q = q.substring(5);
        ...
        var Y = (E.PR = {
                ...
                prettyPrint: (E.prettyPrint = function(a, d) {
                    function f() {
                        for (
                            var b = E.PR_SHOULD_USE_CONTINUATION
                                ? c.now() + 250
                                : Infinity;
                            p < t.length && c.now() < b;
                            p++
