                ...
                if (c)
                    for (var h = 0; h < c.length; h++) {
                        ...
                        void 0 != c[h].fontStyle && void 0 != c[h].fontWeight
                            ? ((k = c[h].fontStyle + c[h].fontWeight),
                              g.push(new H(m, k)))
                            : g.push(new H(m));
                    }
                a(g);
