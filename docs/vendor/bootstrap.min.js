                ...
                if (
                    ...
                    if (
                        ...
                        if ((!o && 27 != t.which) || (o && 27 == t.which))
                            return (
                                27 == t.which && i.find(r).trigger('focus'),
                                e.trigger('click')
                            );
                        var n = i.find(
    ...
    (function(g) {
        ...
        (m.VERSION = '3.4.1'),
            ...
            (m.prototype.init = function(t, e, i) {
                ...
                for (
                    var o = this.options.trigger.split(' '), n = o.length;
                    n--;
            ...
            (m.prototype.getOptions = function(t) {
                ...
                return (
                    ...
                    t.sanitize &&
                        (t.template = n(t.template, t.whiteList, t.sanitizeFn)),
                    t
                );
            }),
                ...
                if (this.hasContent() && this.enabled) {
                    ...
                    r && (s = s.replace(a, '') || 'top'),
                        ...
                        this.options.container
                            ? o.appendTo(
                                  g(document).find(this.options.container),
                              )
    ...
    (function(s) {
        ...
        function n(t, e) {
            (this.$body = s(document.body)),
                (this.$scrollElement = s(t).is(document.body)
                    ? s(window)
                    : s(t)),
                (this.options = s.extend({}, n.DEFAULTS, e)),
