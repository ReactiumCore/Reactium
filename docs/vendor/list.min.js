            ...
            function(a, b, c) {
                b.exports = function(a) {
                    ...
                    var b = {
                            ...
                            setOrder: function(c) {
                                for (var d = 0, e = b.els.length; d < e; d++) {
                                    var f = b.els[d];
                                    if (
                                        a.utils.getAttribute(f, 'data-sort') ===
                                        c.valueName
                                    ) {
                                        var g = a.utils.getAttribute(
                                            f,
                                            'data-order',
                                        );
                                        'asc' == g || 'desc' == g
                        ...
                        c = function() {
                            ...
                            var c = {},
                                d =
                                    ...
                                    void 0;
                            d
                                ? ((c.valueName = a.utils.getAttribute(
                                      d,
                                      'data-sort',
                                  )),
                                ...
                                : ((c = arguments[1] || c),
                                  ...
                                  (c.order = c.order || 'asc'),
                                  (c.insensitive =
                                      'undefined' == typeof c.insensitive ||
                                      c.insensitive)),
                                b.clear(),
                                b.setOrder(c),
                                (c.sortFunction =
                                    c.sortFunction || a.sortFunction),
                    ...
                    return (
                        ...
                        (a.handlers.sortComplete =
                            a.handlers.sortComplete || []),
                        (b.els = a.utils.getByClass(
                            a.listContainer,
                            a.sortClass,
                        )),
                ...
                var d = function(a) {
                    ...
                    (this.clearSourceItem = function(b, c) {
                        ...
                        (this.get = function(b, d) {
                            ...
                            for (var e = {}, f = 0, g = d.length; f < g; f++) {
                                ...
                                if (d[f].data)
                                    ...
                                    d[f].attr && d[f].name
                                        ? ((h = a.utils.getByClass(
                                              b.elm,
                                              d[f].name,
                                              !0,
                                          )),
                                          (e[d[f].name] = h
                                              ? a.utils.getAttribute(
                                                    h,
                                                    d[f].attr,
                                                )
                                              : ''))
                        ...
                        (this.set = function(b, d) {
                            var e = function(b) {
                                    for (
                                        var c = 0, d = a.valueNames.length;
                                        c < d;
                                        c++
                                    )
                                        if (a.valueNames[c].data) {
                                            for (
                                                var e = a.valueNames[c].data,
                                                    f = 0,
                                                    g = e.length;
                                                f < g;
                                                f++
        ...
        12: [
            function(a, b, c) {
                b.exports = function(a, b) {
                    ...
                    if (!c)
                        for (
                            var d = a.attributes, e = d.length, f = 0;
                            f < e;
                            f++
                        )
                            void 0 !== b[f] &&
                ...
                b.exports = function(a, b, c) {
                    var d,
                        ...
                        q = o
                            ...
                            .split('\0'),
                        r =
                            parseInt(n.match(j), 16) ||
                            (1 !== p.length && Date.parse(n)),
                        s =
