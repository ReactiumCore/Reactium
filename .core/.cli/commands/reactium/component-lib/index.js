...
const HELP = () =>
    console.log(`
Example:
  $ arcli library-gen -s components/MyComponentLibrary -d cwd/lib -n MyComponentLibrary
...
const ACTION = ({ opt, props }) => {
    ...
    return new Promise((resolve, reject) => {
        prompt.get(SCHEMA_SOURCE({ props }), (err, input = {}) => {
            if (err) {
                prompt.stop();
            ...
            input = { ...ovr, ...input };
            params = CONFORM({ ...params, input, props });
        ...
        .then(
            () =>
                new Promise((resolve, reject) => {
                    prompt.get(SCHEMA({ props, params }), (err, input = {}) => {
                        if (err) {
                            prompt.stop();
                            reject(`${NAME} ${err.message}`);
                            return;
