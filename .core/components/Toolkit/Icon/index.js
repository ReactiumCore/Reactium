...
export const Catalyst = props => (
    <svg viewBox='0 0 70 70'>
        ...
        <path
            fill='currentColor'
            d='M46 41c0-6-5-11-11-11-9 0-11 7-22 6l-1 5a17 17 0 0 0 34 1v-1z'
        />
        <g fill='#FFF'>
...
export const Organism = props => (
    <svg viewBox='0 0 70 70'>
        <path
            ...
            stroke='#000'
            strokeWidth='4'
            d='M58 13.2c-4.7-3.4-10.3-4-15.3-2.4-2.8.9-5.8.2-7.9-1.9-2.1-2-4.8-3.5-8.1-3.9-6-.8-11.9 2.5-14.4 7.9-1.6 3.4-1.7 6.9-.7 10 .8 2.6.1 5.3-1.7 7.4-4.7 5.6-6.4 13.5-3.6 21C10 61 20.1 66.6 30 64.6c8.3-1.6 14.4-7.9 16.3-15.4.7-2.9 3-5 5.9-5.7 4.5-1.2 8.6-4.2 10.9-8.7A17.2 17.2 0 0 0 58 13.2z'
        />
        ...
        <path
            ...
            strokeWidth='2'
            strokeLinecap='round'
            d='M30 6l1-3m7 8l1-3m9 2V7m10 6l2-3m4 11l3-1m-2 11l3 1m-6 10l-2-3m-9 5l2 3m-8 5l4 2m-10 6l3 3m-11 5l-1-3m-10-1l-1 4m-10-6l3-3m-6-7l-3 1m2-12H2m8-10l-4-1m6-7l-4-1m4-9l-3-1m11-6l-2-3'
        />
    </svg>
);
